...
func TestEqual(t *testing.T) {
	require.Error(t, getError(Equal.Func(nil)))
	require.Error(t, getError(Equal.Func(nil, block.New("1"))))
	require.Equal(t, "false", mustFunc(Equal.Func(nil, block.New("1"), block.New("2"))))
	require.Equal(t, "true", mustFunc(Equal.Func(nil, block.New("1"), block.New("1"), block.New("1"))))
}
